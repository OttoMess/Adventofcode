...
if not os.path.exists(python):
    shutil.copyfile("./2025/blank.txt", python)
    print(f"made: {"/2025/day" + day_number + ".py"}")

    with open(r"2025/day" + day_number + ".py", "r") as file:
        data = file.read()
    ...
    with open(r"2025/day" + day_number + ".py", "w") as file:
        file.write(data)
else:
