...
their supplies. One important consideration is food - in particular, the number of Calories each Elf is carrying
(your puzzle input).
...
file_path = "2023/data/input_puzzle_1.txt"
...
print(f"Elf number: {(elfs.index(max(elfs)))+1}")

elfs.sort()
print(f"Sum of top three : {sum(elfs[-3:])}")
